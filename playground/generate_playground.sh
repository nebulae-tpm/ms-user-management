...
# nebulae compose-api development --api-type=NEBULAE_GATEWAY --api-repo=https://github.com/nebulae-tpm/emi-gateway --api-id=emi-gateway --output-dir=emi-gateway  --setup-file=../etc/emi-mapi-setup.json
# nebulae compose-api development --api-type=NEBULAE_GATEWAY --api-repo=https://github.com/nebulae-tpm/sales-gateway --api-id=sales-gateway --output-dir=sales-gateway  --setup-file=../etc/sales-mapi-setup.json
